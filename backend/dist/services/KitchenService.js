...
class KitchenService {
    ...
    static async addToQueue(data) {
        try {
            ValidationService_1.ValidationService.validateUUID(data.order_item_id);
            // Validar prioridad
            ...
            const itemCheck = await pool.query(`SELECT oi.id, mi.station, mi.preparation_time
         FROM order_items oi
         JOIN menu_items mi ON oi.menu_item_id = mi.id
         WHERE oi.id = $1`, [data.order_item_id]);
...
//# sourceMappingURL=KitchenService.js.map