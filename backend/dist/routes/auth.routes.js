...
router.post('/register/customer', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error en registro de cliente', error);
        res.status(500).json({
            success: false,
            error: error.message
        });
...
router.post('/register/waiter', auth_middleware_1.authenticate, auth_middleware_1.isAdmin, async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error en registro de mesero', error);
        res.status(500).json({
            success: false,
            error: error.message
        });
...
router.post('/login/customer', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error en login de cliente', error);
        res.status(500).json({
            success: false,
            error: error.message
        });
...
router.post('/login/waiter', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error en login de mesero', error);
        res.status(500).json({
            success: false,
            error: error.message
        });
...
router.post('/verify', async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error en verificación de token', error);
        res.status(500).json({
            success: false,
            error: error.message
        });
...
router.get('/me', auth_middleware_1.authenticate, async (req, res) => {
    try {
        ...
        logger_1.logger.error('Error al obtener datos del usuario', error);
        res.status(500).json({
            success: false,
            error: error.message
        });
