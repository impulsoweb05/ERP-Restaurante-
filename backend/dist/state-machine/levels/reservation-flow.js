...
exports.handleReservationFlow = handleReservationFlow;
...
async function handleReservationFlow(session, message) {
    try {
...
Escribe un número:`,
        ...
        if (step === 4) {
            ...
            const result = await TableService_1.TableService.getAvailableTables();
...
¡Te esperamos!`;
        ...
        logger_1.logger.error('Error in reservation flow', error);
        return {
...
//# sourceMappingURL=reservation-flow.js.map