...
export class CustomerService {
  ...
  static async findByPhone(phone: string): Promise<Customer | null> {
    try {
      ...
      logger.error('Error finding customer by phone', error as Error);
      throw error;
    }
  }
  ...
  static async create(data: {
    ...
    try {
      ...
      logger.info('Customer created', { customer_code, phone: normalized_phone });
  ...
  static async updateAddresses(
    customerId: string,
    addresses: { address_1?: string; address_2?: string; address_3?: string }
  ): Promise<Customer> {
    try {
      ...
      logger.error('Error updating customer addresses', error as Error);
      throw error;
    }
  }
  ...
  static async findById(customerId: string): Promise<Customer | null> {
    try {
      ...
      logger.error('Error finding customer by id', error as Error);
      throw error;
    }
  }
  ...
  static async getAllCustomers() {
    try {
      ...
      logger.error('Error getting all customers', error as Error);
      throw error;
    }
  }
  ...
  static async deleteCustomer(customerId: string) {
    try {
      ...
      logger.error('Error deleting customer', error as Error);
      throw error;
    }
  }
}
